...
This is a template for deploying a Single Windows server running a private instance of WebPageTest.
...
heat --os-username <OS-USERNAME> --os-password <OS-PASSWORD> --os-tenant-id \
  ...
  stack-create webpagetest -f private-webpagetest-single.yaml \
  -P server_hostname=my-site
```
...
* `server_hostname`: Hostname to set for the server (Default: WebPageTest)
* `image`: Operating System to use (Default: Windows Server 2012 R2)
...
to login. Once you disconnect from RDP, reboot the server to allow the
webpagetest user to login automatically.
...
safe to change settings and configurations on your server.
